...
# ============================================
# РАСЧЁТ СТОИМОСТИ В ЗВЁЗДАХ
# ============================================

# Маржа для расчёта стоимости (1.75 = 75% наценка)
STAR_MARGIN = 1.75

# Курс доллара для расчётов
USD_TO_RUB = 100

# Стоимость 1 звезды в рублях (из подписки Mini: 490₽ = 4000⭐)
STAR_COST_RUB = 0.1225  # 490 / 4000
